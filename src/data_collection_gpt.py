...
class DataBot:
        ...
        self.data_message_log = [
            {
                "role": "system",
                "content": """ 
			I want to develop a dataset which contains Questions asked and Answers in Nepali (Devanagari) language. Include subjective questions. The questions may be from any field or related to any context
    ...
    def generate_responses(self, count):
        ...
        with open("dataset/subjective_dataset.json", "w") as json_file:
...
if __name__ == '__main__':
    ...
    print(f"The {max_data} data generated in {time.perf_counter() - start_time:.2f} seconds")
    # print(responses)